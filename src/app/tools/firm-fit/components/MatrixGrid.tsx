  ...
  return (
    <div className="grid max-w-full gap-3.5 overflow-x-hidden md:grid-cols-2 lg:grid-cols-3 sm:gap-4">
      {results.map((result) => {
        ...
        return (
          <article key={result.firm.id} className="min-w-0 rounded-2xl border border-purple-900/30 bg-slate-900/70 p-2.5 shadow-xl shadow-indigo-950/20 backdrop-blur-xl transition-all duration-300 hover:border-purple-500/40 sm:p-3.5">
