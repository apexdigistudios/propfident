...
export function AccountSelector({
  ...
  return (
    <label className="flex items-center gap-2 rounded-xl border border-purple-500/30 bg-slate-900/90 px-3 py-2">
      <Server className="h-4 w-4 text-purple-300" />
      <select
        ...
        className="min-w-[220px] bg-transparent text-sm font-semibold text-slate-100 outline-none"
      >
